...
#-----------------------------------------------
                ...
                ki.sendText(msg.to, "%" % (elapsed_time))
                kk.sendText(msg.to, "%" % (elapsed_time))
                kc.sendText(msg.to, "%" % (elapsed_time))
...
#------------------------------------------------------------------
            ...
            elif msg.text in ["Kill ban","เตะแบน"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
                    gMembMids = [contact.mid for contact in group.members]
                    matched_list = []
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"คุญอยู่ในรายชื่อสีดำ")
                        ki.sendText(msg.to,"")
                        kk.sendText(msg.to,"")
                        kc.sendText(msg.to,"")
                        return
